...
public class UserController {
    ...
    public ResponseEntity<Page<User>> getUsersContainsRoles(
        ...
        Page<User> users = userService.getUsersByRoleName(name, new PageRequest(page, size));
    ...
    public ResponseEntity<Page<User>> getUsersEqualsRoles(
        ...
        Page<User> users = userService.getUsersByRoleNameContains(name, new PageRequest(page, size));
        return new ResponseEntity<>(users, HttpStatus.OK);
    }
